      ...
      <form class="bs-example form-horizontal">
        <fieldset>          
          <div class="form-group">
            ...
            <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->name; ?></div>
            </div>
          </div>
          <div class="form-group">
            <label for="inputName" class="col-lg-4 control-label">Apellido :</label>
            <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->last_name; ?></div>
            </div>
          </div>
          <div class="form-group">
            <label for="inputName" class="col-lg-4 control-label">Nombre de usuario :</label>
            <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->username; ?></div>
            </div>
          </div>                  
          <div class="form-group">
            <label for="inputName" class="col-lg-4 control-label">Correo :</label>
              <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->email; ?></div>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-4 control-label">Sexo :</label>
              <div class="col-lg-8">                  
                    <?php if($_SESSION["current_user"]->gender == "m"){ ?>
           ...
           <div class="form-group">
            <label for="inputName" class="col-lg-4 control-label">Ciudad :</label>
             <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->city; ?></div>
            </div>
          </div>
          <div class="form-group">
            <label for="select" class="col-lg-4 control-label">Situacion :</label>
             <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->relationship_status; ?></div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
                <div style="margin-top: 11px;"><?php echo $_SESSION["current_user"]->birthday->format('d-m-Y') ?></div>
            </div>
           </div>                                          
        </fieldset>
      </form>
       ...
       <form class="bs-example form-horizontal" action="index.php" method="post">
        <fieldset>          
          <div class="form-group">
            ...
            <div class="col-lg-9">
                <input type="text" value="<?php echo $_SESSION["current_user"]->name; ?>" name="new_name" cannot-be-blank class="form-control" id="inputName" placeholder="Nombre" required maxlength="50">
            </div>
          </div>
          <div class="form-group">
            <label for="inputName" class="col-lg-3 control-label">Apellido</label>
            <div class="col-lg-9">
              <input type="text" value="<?php echo $_SESSION["current_user"]->last_name; ?>" name="new_last_name" class="form-control" id="inputName" placeholder="Apellido" maxlength="50">
            </div>
          </div>                 
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-lg-9">
              <input type="text" value="<?php echo $_SESSION["current_user"]->city; ?>" name="new_city" class="form-control" id="inputName" placeholder="Ciudad" maxlength="40">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <select class="form-control" id="select" name="new_relationship">
                <?php if($_SESSION["current_user"]->relationship_status == "Soltero(a)"){?>                  
                    <option selected>Soltero(a)</option>
                <?php }else{?>
                    <option>Soltero(a)</option>
                <?php }?>
                <?php if($_SESSION["current_user"]->relationship_status == "Casado(a)"){?>                  
                    <option selected>Casado(a)</option>
                <?php }else{?>
                    <option>Casado(a)</option>
                <?php }?>
                <?php if($_SESSION["current_user"]->relationship_status == "Tiene una relacion"){?>                  
                    <option selected>Tiene una relacion</option>
                <?php }else{?>
                    <option>Tiene una relacion</option>
                <?php }?>                
                  <?php if($_SESSION["current_user"]->relationship_status == "Separado(a)"){?>                  
                    <option selected>Separado(a)</option>
                <?php }else{?>
                    <option>Separado(a)</option>
                <?php }?> 
                  <?php if($_SESSION["current_user"]->relationship_status == "Divorciado(a)"){?>                  
                    <option selected>Divorciado(a)</option>
                <?php }else{?>
                    <option>Divorciado(a)</option>
                <?php }?>  
                  <?php if($_SESSION["current_user"]->relationship_status == "Viudo(a)"){?>                  
          ...
          <div class="form-group">
            ...
            <div id="datetimepicker4" class="input-append input-group col-lg-8">
              <input class="form-control input-append" value="<?php echo $_SESSION["current_user"]->birthday->format('d-m-Y') ?>"style="width:345px;" data-format="dd-MM-yyyy" type="text" name="new_birthday"></input>
